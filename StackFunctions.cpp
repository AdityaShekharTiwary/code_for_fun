...
class Stack{
  ...
  public:
    ...
    int peek(int pos)
    {
        ...
        {
            arr[pos]=val;
            cout << "val changed at the location" << pos << endl;
        }
...
int main()
 {
   ...
   do
   {
       ...
       {
       case 1:
        cout <<"Enter an item to pushin the stack"<<endl;
        cin>>value;
        s1.push(value);
             break;
       case 2:
       ...
       case 5:
            ...
            break;
       case 6:
            cout<< "Count Function called - Number of Item you want to change : ";
            break;
       case 7:
            cout << "Change function called-" << endl;
            cout << "Enter position of items you want to change: ";
            cin >> position;
            cout << endl;
